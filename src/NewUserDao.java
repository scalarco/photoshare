...
public class NewUserDao {
  ...
  private static final String NEW_USER_STMT = "INSERT INTO " +
      "Users (email, password, firstname, lastname, dob, gender, education) VALUES (?, ?, ?, ?, ?, ?, ?)";

  public boolean create(String email, String password, String fname, String lname, String dob, String gen, String edu) {
